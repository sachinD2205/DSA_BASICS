...
//! 1st approch - two pointer
var merge1 = function (nums1, m, nums2, n) {
    const nums3 = [...nums1];
    // or const nums3 = Array.from(nums1); 
    // or const nums3 = new Array(...nums1);
    // or const nums3 = nums.slice(0,m);
    let indexM = 0;
    let indexN = 0;
    ...
    for (let i = 0; i < m + n; i++) {
        if (indexN>=n ||(nums3[indexM] <= nums2[indexN] && indexM<m) ) {
